...
3. Create a buffer around each substance abuse center of 25 miles. Count up the number of hospitals within each buffer. Create a map of buffers where the color of the buffers represents the number of hospitals within each buffer. Do the same for a buffer of 75 miles.
...
distances <- st_distance(SUD_centers, hospitals)
